...
async function runPackPreviewJob(job: any) {
  ...
  if (selectedStyleHint) {
    console.log("[PackPreview] Using style prompt from", session.prompt_final ? "session.prompt_final" : "style_preset.prompt_hint");
  }
