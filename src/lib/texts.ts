...
const fallbackTexts: Record<string, Record<string, string>> = {
  ru: {
    ...
    "edit.need_photo": "📸 Пришли фото с лицом, которое нужно вставить в стикер:",
    "edit.replace_face_no_photo": "📸 Сначала отправь фото — оно нужно для замены лица в стикере.",
    "edit.photo_received": "Фото получено! Теперь нажми \"Заменить лицо\" 👇",
    "action.choose": "Что хочешь сделать с этим фото?",
    "action.photo_sticker": "📸 Фото в стикер",
    "action.remove_bg": "🖼 Удалить фон",
    "action.replace_face": "🧑 Заменить лицо (1💎)",
    "action.make_sticker": "🎨 Изменить стиль (1💎)",
    "action.make_pack": "📦 Создать стикер пак",
    "action.replace_face_send_sticker": "Пришли стикер, в котором хочешь заменить лицо 👇",
  ...
  en: {
    ...
    "edit.need_photo": "📸 Send a photo with the face you want to put on the sticker:",
    "edit.replace_face_no_photo": "📸 Send a photo first — it's needed to replace the face in the sticker.",
    "edit.photo_received": "Photo received! Now tap \"Replace face\" 👇",
    "action.choose": "What do you want to do with this photo?",
    "action.photo_sticker": "📸 Photo to sticker",
    "action.remove_bg": "🖼 Remove background",
    "action.replace_face": "🧑 Replace face (1💎)",
    "action.make_sticker": "🎨 Change style (1💎)",
    "action.make_pack": "📦 Create sticker pack",
    "action.replace_face_send_sticker": "Send the sticker where you want to replace the face 👇",
