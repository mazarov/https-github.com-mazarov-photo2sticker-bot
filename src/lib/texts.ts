...
const fallbackTexts: Record<string, Record<string, string>> = {
  ru: {
    ...
    "pack.carousel_intro": "Выбери набор фраз и эмоций для стикеров — от него зависят подписи на каждом стикере.",
  ...
  en: {
    ...
    "pack.carousel_intro": "Choose a set of phrases and emotions for your stickers — it defines the caption on each sticker.",
