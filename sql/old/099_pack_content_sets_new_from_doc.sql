-- 099_pack_content_sets_new_from_doc.sql (ПРОД)
-- Новые наборы паков из docs/19-02-pack-new-sets.md с привязкой к сегментам (098).
-- Только таблица pack_content_sets. Для теста отдельно: 100_test_pack_content_sets_new.sql.
