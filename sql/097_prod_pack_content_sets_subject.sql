...
(
  ...
  1, true, 'humor', 9, 'single', true, 'sarcasm'
),
-- sass
(
  'sass',
  ...
  6, true, 'sarcasm', 9, 'single', false, 'sarcasm'
),
...
(
  ...
  2, true, 'everyday', 9, 'single', false, 'home'
),
-- thanks_solo (3)
(
  'thanks_solo',
  ...
  3, true, 'thanks', 9, 'single', false, 'affection_support'
),
...
(
  ...
  4, true, 'reactions', 9, 'single', false, 'reactions'
),
-- affection_solo (5)
(
  'affection_solo',
  ...
  5, true, 'affection', 9, 'single', false, 'affection_support'
),
...
(
  ...
  7, true, 'reactions', 9, 'single', false, 'reactions'
),
-- holiday_solo (прод: 8)
(
  'holiday_solo',
  ...
  8, true, 'holiday', 9, 'single', false, 'events'
);
