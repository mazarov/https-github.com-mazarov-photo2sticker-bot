-- 106_test_reactions_daily_v3.sql (ТЕСТ)
...
(
  ...
  '["{subject} in soft morning shirt, stretching upward while holding a phone in other hand, sleepy smile", "{subject} in loose home clothes, rubbing eyes while holding pillow against chest", "{subject} casually dressed, holding phone near heart with soft longing expression", "{subject} in work outfit or shirt, focused posture with laptop or tablet slightly visible", "{subject} loosening collar or adjusting hair, shoulders slightly dropped in tired gesture", "{subject} holding snack or takeout bag playfully touching stomach with exaggerated hunger face", "{subject} wearing jacket or hoodie, putting one arm through sleeve energetically as if about to leave", "{subject} slight shrug while holding keys or phone, relaxed neutral half-smile", "{subject} in soft evening clothes, wrapped lightly in blanket, gentle wave with calm night expression"]'::jsonb,
